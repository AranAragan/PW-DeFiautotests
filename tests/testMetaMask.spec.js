...
test_1.test.describe("Swap", () => {
    ...
    (0, test_1.test)("BSCMetaMask connect", async () => {
        await wallet.importPK('0xde9be858da4a475276426320d5e9262ecfc3ba460bfac56360bfa6c4c28b4ee0');
        await (0, test_1.expect)(wallet.addNetwork({ networkName: 'Testnet', rpc: 'http://localhost:8545', chainId: 1337, symbol: 'BNB',
...
test_1.test.describe("Regress", () => {
    (0, test_1.test)('API', async ({ page }) => {
    ...
    (0, test_1.test)('Simple mode', async ({ page }) => {
        await page.goto('https://yad.finance/');
    ...
    (0, test_1.test)('Widget', async ({ page }) => {
        await page.goto('https://yad.finance/');
        await page.click('[href="https://app.yad.finance"]:nth-child(3)');
    ...
    (0, test_1.test)('Change a network', async ({ page }) => {
        await page.goto('https://yad.finance/');
    ...
    (0, test_1.test)('visible', async ({ page }) => {
        await page.goto('https://yad.finance/');
        await (0, test_1.expect)(page.getByRole('heading', { name: 'Simple and efficient multichain swap aggregator' })).toBeVisible();
        await (0, test_1.expect)(page.getByText('Find the best rate andswap 3500+ tokens in 6 chainsin one click')).toBeVisible();
