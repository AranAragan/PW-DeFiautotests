...
test_1.test.describe("Swap", () => {
    ...
    (0, test_1.test)("Polygon MetaMask connect", async () => {
        ...
        await wallet.addNetwork({ networkName: "Optimism", rpc: "https://frosty-magical-vineyard.optimism.quiknode.pro/9746a26b51ed60ea1fcea4f19575c1b0ab73b922/", chainId: 10, symbol: "ETH" });
        ...
        await testPage.goto("http://localhost:3000/10/exchange/eth/usdt");
        await testPage.evaluate(() => {
            localStorage["testNetwork"] = '{"maskId":"10"}';
        });
